...
const ADVENT_ENTRIES: AdventEntry[] = [
  ...
  // 9日
  {
    ...
    seriesId: 'series1',
    abstract:
      '転送行列の議論からはじめてテンソルネットワークの基本的な概念について紹介します',
  },
  // 10日
  {
    date: '2025-12-10',
  ...
  // 11日
  {
    ...
    seriesId: 'series1',
    abstract:
      '誤差の重要性、誤差の表記法、不一致とは何か、統計誤差と系統誤差の違いなど誤差解析を行う上で基礎的な事柄について述べる。',
  },
  // 12日
  {
    date: '2025-12-12',
    ...
    seriesId: 'series1',
    abstract:
      '自由粒子→TB ハミルトニアン　空間並進対称性が破れると波数空間が「おりたたまれる」ことを理解する。',
  },
  // 13日
  {
    date: '2025-12-13',
  ...
  // 14日
  {
    ...
    seriesId: 'series1',
    abstract:
      '微分方程式をオイラー法やルンゲクッタ法で解く方法の基礎付けとパイソンでの実装を軽く紹介したいと考えています。',
  },
  // 15日
  {
    date: '2025-12-15',
    ...
    seriesId: 'series1',
    abstract:
      'テンソルネットワークにおける"繰り込み"の概念について紹介し、代表的な計算手法とその応用について扱います',
  },
  // 16日
  {
    date: '2025-12-16',
  ...
  // 17日
  {
    ...
    seriesId: 'series1',
    abstract:
      '恐らく加速器の種類とか原理とかを書く予定ですが、場合によっては検出器周りを書いたり、過去の有名な実験を書くかもです。',
  },
  // 18日
  {
    date: '2025-12-18',
  ...
  // 19日
  {
    ...
    seriesId: 'series1',
    abstract:
      '平均、重み付き平均に対する標準偏差(SDOM)はどう計算されるかを述べ、それを応用して最小二乗法及び重み付き最小二乗法によるフィッティングのパラメタが持つ誤差について解説する。できればその際の系統誤差の扱いにも触れたい。',
  },
  // 20日
  {
    date: '2025-12-20',
  ...
  // 21日
  {
    ...
    seriesId: 'series1',
    abstract:
      '「統一後のドイツ」を楽しく読むための予備知識として、前半部でBundestagswahl 2025について振り返り、後半部でドイツ再統一過程について簡単にご紹介し、ドイツ史・ドイツ政治の魅力を語ります！！！！！',
  },
  // 22日
  {
    date: '2025-12-22',
    ...
    seriesId: 'series1',
    abstract:
      'MERAネットワークと共形場理論からAdS/CFT対応について議論し、ブラックホールの誤り訂正符号としての解釈を目指します',
  },
  // 23日
  {
    date: '2025-12-23',
    ...
    seriesId: 'series1',
    abstract:
      'HGP codeから高次元の表面符号を構成します。量子エラー訂正符号の話です。',
  },
  // 24日
  {
    date: '2025-12-24',
    ...
    seriesId: 'series1',
    abstract:
      '数十億円使って空にロケット打ちあげて電子ビームを放出すれば何とかなるのではという話',
  },
  // 25日
  {
    date: '2025-12-25',
  ...
  // 3日
  {
    ...
    seriesId: 'series2',
    abstract:
      'Virasoro代数がLie代数の中心拡大として得られることを頑張って書きます。',
  ...
  // 13日
  {
    ...
    seriesId: 'series2',
    abstract:
      'トポロジカル超伝導体についてMajorana fermionとかの話をしたいです',
  },
  // 17日
  {
    date: '2025-12-17',
  ...
  // 22日
  {
    ...
    seriesId: 'series2',
    abstract:
      'トポロジカル周期表について解説します。どれかの記事は書くのが遅れてしまうかもしれません🙏',
  },
  // 23日
  {
    date: '2025-12-23',
    ...
    seriesId: 'series2',
    abstract:
      '1と2で書ききれなかったところや気付いたところ、あと誤差に関する愚痴を喋る。',
  },
  // 24日
  {
    date: '2025-12-24',
  ...
  for (let week = 0; week < 6; week++) {
    ...
    for (let weekday = 0; weekday < 7; weekday++) {
      ...
      if (cellIndex < firstWeekday) {
        // 前月の日付
        const day = daysInPrevMonth - (firstWeekday - 1) + cellIndex;
...
export default function AdventCalendarPage() {
  ...
  const baseDate = useMemo(() => new Date(ADVENT_YEAR, ADVENT_MONTH, 1), []);
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 pt-8 pb-8 space-y-6">
        ...
        <About />
        {/* ページヘッダ */}
        <header className="text-center space-y-3 md:space-y-2">
          <p className="text-xs uppercase tracking-wide text-zinc-500">
            Advent Calendar 2026
          </p>

          <h1 className="font-semibold text-[#444443] text-2xl sm:text-3xl md:text-4xl leading-tight">
            Physics Lab. アドベントカレンダー
          </h1>

          <div className="mx-auto max-w-[36rem] space-y-1.5 text-xs text-zinc-500 leading-relaxed">
            <p>記事が投稿されるのは 12/1 〜 12/25 までです。</p>
            <p>シリーズを切り替えて各日の記事をチェックできます。</p>
            {/* <p>（PCではホバー、SPではタップで閲覧できます。）</p> */}
          </div>
        </header>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-5xl px-2">
            <div className="flex gap-2 overflow-x-auto py-1 no-scrollbar justify-center md:justify-center">
              {SERIES.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      'min-h-[40px] leading-none', // タップしやすく
                      isActive
            ...
            {weeks.slice(0, 4).map((week, i) => (
              <div key={i} className="grid border-b grid-cols-7 gap-1">
                ...
                {week.map(({ date, inCurrentMonth }) => {
                  ...
                  // アドカレ範囲外は記事なし（リンクなし）
                  const inAdventRange = inCurrentMonth && day >= 1 && day <= 25;
                  ...
                  const isToday =
                    today !== null && formatDateKey(date) === today;
                  ...
                  const inner = (
                    <>
                      {isNew && <NewBadge className="absolute top-1 right-1" />}
